...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/LCD-Hello_World.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=Simple1.asm config.asm UART.asm LCD.asm KeyPad.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Simple1.o ${OBJECTDIR}/config.o ${OBJECTDIR}/UART.o ${OBJECTDIR}/LCD.o ${OBJECTDIR}/KeyPad.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Simple1.o.d ${OBJECTDIR}/config.o.d ${OBJECTDIR}/UART.o.d ${OBJECTDIR}/LCD.o.d ${OBJECTDIR}/KeyPad.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Simple1.o ${OBJECTDIR}/config.o ${OBJECTDIR}/UART.o ${OBJECTDIR}/LCD.o ${OBJECTDIR}/KeyPad.o

# Source Files
SOURCEFILES=Simple1.asm config.asm UART.asm LCD.asm KeyPad.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/LCD-Hello_World.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/LCD-Hello_World.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION)  -w -x -u_DEBUG -z__ICD2RAM=1 -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"   -z__MPLAB_BUILD=1  -z__MPLAB_DEBUG=1 -z__MPLAB_DEBUGGER_ICD3=1 $(MP_LINKER_DEBUG_OPTION) -odist/${CND_CONF}/${IMAGE_TYPE}/LCD-Hello_World.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
else
dist/${CND_CONF}/${IMAGE_TYPE}/LCD-Hello_World.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION)  -w  -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"   -z__MPLAB_BUILD=1  -odist/${CND_CONF}/${IMAGE_TYPE}/LCD-Hello_World.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
endif
