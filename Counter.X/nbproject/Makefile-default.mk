...
${OBJECTDIR}/Counter_Program.o: Counter_Program.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/Counter_Program.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_SIMULATOR=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/Counter_Program.lst\" -e\"${OBJECTDIR}/Counter_Program.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/Counter_Program.o\" \"Counter_Program.asm\" 
