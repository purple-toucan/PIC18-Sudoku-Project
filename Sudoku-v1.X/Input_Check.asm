...
OVRWRT	res 1		; reserve one byte for storing previous keypad entry
...
rdlp
	...
	movf	OVWRT, W	; Moving previous written value to W
	cpfseq	key_val		; Comparing key_val with W. Skips if same
